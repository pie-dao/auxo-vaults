...
// Interfaces
// safe erc20 is just used to attach to interface
...
// Contracts
import {LayerZeroAppUpgradeable} from "./LayerZeroAppUpgradeable.sol";

// import {CallFacet} from "./CallFacet.sol";

/// @title XChainHub with stargate support
/// @dev Expect this contract to change in future.
contract XChainStargateHubUpgradeable is
    LayerZeroAppUpgradeable,
    IStargateReceiver
{
    ...
    function initialize(
        ...
        // initializers
        LayerZeroAppUpgradeable.initialize(_lzEndpoint);
